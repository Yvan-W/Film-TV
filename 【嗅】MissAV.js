...
// 网站主页
const webSite = 'https://missav.ai'
// 网站搜索
// https://www.clicli.pro/search/page/2/wd/海.html
// 把网站主页变成 @{webSite} 把搜索词变成 @{searchWord}  把页码变成 @{page}
const searchUrl = '@{webSite}/search/@{searchWord}?page=@{page}.html'
// 当前网站任意视频详情页
// https://www.clicli.pro/bangumi/3384.html
const videoDetailPage = '@{webSite}/musume-061326_01.html'
// 当前网站任意视频播放页
// https://www.clicli.pro/video/3384/1-1.html
const videoPlayPage = '@{webSite}musume-061326_01.html'
...
const firstClass = [
    {
        ...
        id: '@{webSite}/dm278/chinese-subtitle?page=@{page}.html',
    },
    {
        name: 'FC2',
        // https://www.clicli.pro/show/id/2/page/2.html
        // 把网站主页变成 @{webSite}  把页码变成 @{page}
        id: '@{webSite}/dm492/fc2?page=@{page}.html',
    },
]
